...
import com.hanna2100.cleannote.framework.datasource.cache.database.NOTE_FILTER_TITLE
import com.hanna2100.cleannote.framework.datasource.cache.database.NOTE_ORDER_ASC
                ...
                uiComponentType = UIComponentType.SnackBar(
                    ...
                    onDismissCallback = object: TodoCallback {
                        override fun execute() {
                            // undo 하지 않으면 pending 상태에 있는 노트를 비운다
