...
import com.hanna2100.cleannote.business.interactors.common.DeleteNote.Companion.DELETE_ARE_YOU_SURE
import com.hanna2100.cleannote.business.interactors.common.DeleteNote.Companion.DELETE_NOTE_SUCCESS
import com.hanna2100.cleannote.business.interactors.notedetail.UpdateNote.Companion.UPDATE_NOTE_FAILED_PK
import com.hanna2100.cleannote.business.interactors.notedetail.UpdateNote.Companion.UPDATE_NOTE_SUCCESS
import com.hanna2100.cleannote.framework.presentation.common.*
import com.hanna2100.cleannote.framework.presentation.notedetail.state.CollapsingToolbarState.*
...
import com.hanna2100.cleannote.framework.presentation.notedetail.state.NoteInteractionState.*
import com.hanna2100.cleannote.framework.presentation.notelist.NOTE_PENDING_DELETE_BUNDLE_KEY
...
const val NOTE_DETAIL_STATE_BUNDLE_KEY = "com.hanna2100.cleannote.notes.framework.presentation.notedetail.state"
...
//        getAppComponent().inject(this)
            ...
            CreateStateMessageEvent(
                stateMessage = StateMessage(
                    response = Response(
                        ...
                        uiComponentType = UIComponentType.AreYouSureDialog( object : AreYouSureCallback {
    ...
    private fun onDeleteSuccess(){
        ...
        findNavController().navigate(
            R.id.action_note_detail_fragment_to_noteListFragment, bundle
        )
    }
